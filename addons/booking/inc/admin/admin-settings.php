...
function nd_learning_paypal_settings() {
  ...
  $nd_learning_clean_settings = array(
    'type' => 'string',
    'sanitize_callback' => 'sanitize_text_field',
    'default' => NULL,
  );

  register_setting( 'nd_learning_paypal_settings_group', 'nd_learning_paypal_developer', $nd_learning_clean_settings );
  register_setting( 'nd_learning_paypal_settings_group', 'nd_learning_paypal_email', $nd_learning_clean_settings );
  register_setting( 'nd_learning_paypal_settings_group', 'nd_learning_paypal_token', $nd_learning_clean_settings );
  register_setting( 'nd_learning_paypal_settings_group', 'nd_learning_paypal_currency', $nd_learning_clean_settings );
}
