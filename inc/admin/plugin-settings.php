...
function nd_learning_settings() {
  ...
  register_setting( 'nd_learning_settings_group', 'nd_learning_currency', $nd_learning_clean_settings );
  register_setting( 'nd_learning_settings_group', 'nd_learning_account_page',$nd_learning_clean_settings );
  register_setting( 'nd_learning_settings_group', 'nd_learning_container', $nd_learning_clean_settings );
